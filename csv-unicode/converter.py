...
def extract_verse_chapter(line):
    ...
    chap_verse_patt = r"[0-9]+:[0-9]+" # The chapter and verse come in this format: "XX:XX"
...
def convert_beta_to_unicode(beta):
    ...
    unicode_result = unicode_result.replace("  ]", "]") # Removing the auxiliary spaces we added for the sigmas
...
print("CONVERTING ALL BOOKS AND KEEPING TEXTUAL VARIANTS - SAVING TO THE with-variants FOLDER")
convert_all_books_to_unicode(drop_variants=False)
print("Done.")
print("\n---\n")
print("CONVERTING ALL BOOKS AND DROPPING TEXTUAL VARIANTS - SAVING TO THE no-variants FOLDER")
